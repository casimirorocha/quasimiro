...
function extendConf (conf, api) {
  ...
  conf.boot.push('~quasar-app-extension-my-login/src/boot/register-my-component.cjs')

  if (api.hasVite !== true) {
    // make sure boot & component files get transpiled
    conf.build.transpileDependencies.push(/quasar-app-extension-my-login[\\/]src/)
  }

  // make sure my-ext css goes through webpack to avoid ssr issues
  conf.css.push('~quasar-app-extension-my-login/src/component/LoginForm.sass')
}
